...
class WelcomesControllerTest < ActionController::TestCase
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post :create, welcome: { description: @welcome.description, mail: @welcome.mail, phone: @welcome.phone, title: @welcome.title }
    end
  ...
  test "should update welcome" do
    put :update, id: @welcome, welcome: { description: @welcome.description, mail: @welcome.mail, phone: @welcome.phone, title: @welcome.title }
    assert_redirected_to welcome_path(assigns(:welcome))
  end
